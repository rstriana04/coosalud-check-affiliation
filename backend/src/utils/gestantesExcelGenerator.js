...
import { buildGestantesColumns, mapGestantesRow } from './gestantesExcelColumns.js';

const SHEET_CONFIG = {
  sheetName: 'BASE CPN',
  title: 'BASE CONTROL PRENATAL',
  columns: buildGestantesColumns,
  dataMapper: mapGestantesRow
};

export async function generateGestantesExcel(records, outputPath) {
